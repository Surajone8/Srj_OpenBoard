            ...
            {cursorState.mode === CursorMode.Chat && (
                ...
                <>
                    ...
                    <div className='absolute left-2 top-5 bg-blue-500 px-4 py-2 text-sm leading-relaxed text-white rounded-[20px]' onKeyUp={(e) => e.stopPropagation()}>
                        ...
                        <input onChange={handelChange} onKeyDown={handelKeyDown} placeholder={cursorState.previousMessage ? "" : "Type a message"} value={cursorState.message} maxLength={50} className='z-10 w-60 border-none bg-transparent outline-none text-white placeholder-blue-300' autoFocus={true} type="text" />
                    </div>
                </>
            )}
        </div>
